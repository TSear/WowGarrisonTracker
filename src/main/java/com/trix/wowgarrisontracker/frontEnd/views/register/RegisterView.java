package com.trix.wowgarrisontracker.frontEnd.views.register;
...
public class RegisterView extends VerticalLayout {
    ...
    public RegisterView(AccountService accountService, ServerService serverService) {
    ...
    private Button createCancelButton() {
        ...
        cancelButton.addClickListener(event -> UI.getCurrent().navigate(LoginView.class));
        return cancelButton;
    }
